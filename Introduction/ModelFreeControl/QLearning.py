...
class QLearning:
    ...
    def generate_episode(self):
        ...
        while True:
            ...
            self.Q[state][action] += self.alpha * (reward + self.discount_factor * max(self.Q[next_state]) - self.Q[state][action])
...
agent = QLearning(env)
policy = agent.learn(10_000_000)
with open('Qlearning.txt', 'w') as f:
